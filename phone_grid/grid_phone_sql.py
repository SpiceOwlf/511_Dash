...
df = df.query("brand == 'Motorola' or brand == 'Nokia'"
              "or brand == 'Samsung' or brand == 'Sony' "
              "or brand == 'Apple' or brand == 'Xiaomi' "
              "or brand == 'HUAWEI' or brand == 'OnePlus' "
              "or brand == 'Google' or brand == 'ASUS'")
...
app.layout = html.Div([
    ...
    html.Button('Revert All Actions', id='revert-action-all', n_clicks=0),
...
def make_change_to_dataframe(dataframe):
    ...
    if final is not None:
        ...
        dataframe.to_sql('Products', conn)
        conn.close()
        return True
    else:
        return False
